# Wrapper generato automaticamente per il comando Enable-NetIPsecRule
...
function Enable-NetIPsecRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Enable-NetIPsecRule
    # Ad esempio:
    $result = &Enable-NetIPsecRule @PSBoundParameters
    return $result
}
