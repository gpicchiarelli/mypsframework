# Wrapper generato automaticamente per il comando Rename-NetIPsecRule
...
function Rename-NetIPsecRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Rename-NetIPsecRule
    # Ad esempio:
    $result = &Rename-NetIPsecRule @PSBoundParameters
    return $result
}
