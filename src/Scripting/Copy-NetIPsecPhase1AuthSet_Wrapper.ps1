# Wrapper generato automaticamente per il comando Copy-NetIPsecPhase1AuthSet
...
function Copy-NetIPsecPhase1AuthSet {
    ...
    # Inserisci qui la logica per utilizzare il comando Copy-NetIPsecPhase1AuthSet
    # Ad esempio:
    $result = &Copy-NetIPsecPhase1AuthSet @PSBoundParameters
    return $result
}
