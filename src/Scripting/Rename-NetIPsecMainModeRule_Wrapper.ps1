# Wrapper generato automaticamente per il comando Rename-NetIPsecMainModeRule
...
function Rename-NetIPsecMainModeRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Rename-NetIPsecMainModeRule
    # Ad esempio:
    $result = &Rename-NetIPsecMainModeRule @PSBoundParameters
    return $result
}
