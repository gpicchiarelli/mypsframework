# Wrapper generato automaticamente per il comando Disable-NetIPsecRule
...
function Disable-NetIPsecRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Disable-NetIPsecRule
    # Ad esempio:
    $result = &Disable-NetIPsecRule @PSBoundParameters
    return $result
}
