# Wrapper generato automaticamente per il comando Disable-NetIPsecMainModeRule
...
function Disable-NetIPsecMainModeRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Disable-NetIPsecMainModeRule
    # Ad esempio:
    $result = &Disable-NetIPsecMainModeRule @PSBoundParameters
    return $result
}
