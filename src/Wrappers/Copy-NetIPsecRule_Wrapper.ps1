# Wrapper generato automaticamente per il comando Copy-NetIPsecRule
...
function Copy-NetIPsecRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Copy-NetIPsecRule
    # Ad esempio:
    $result = &Copy-NetIPsecRule @PSBoundParameters
    return $result
}
