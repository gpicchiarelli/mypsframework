# Wrapper generato automaticamente per il comando Get-NetTCPSetting
...
function Get-NetTCPSetting {
    param (
        ...
        [CimInstance] $AssociatedTransportFilter,
    ...
    # Inserisci qui la logica per utilizzare il comando Get-NetTCPSetting
    # Ad esempio:
    $result = &Get-NetTCPSetting @PSBoundParameters
    return $result
}
