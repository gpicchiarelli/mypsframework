# Wrapper generato automaticamente per il comando Copy-NetIPsecMainModeCryptoSet
...
function Copy-NetIPsecMainModeCryptoSet {
    ...
    # Inserisci qui la logica per utilizzare il comando Copy-NetIPsecMainModeCryptoSet
    # Ad esempio:
    $result = &Copy-NetIPsecMainModeCryptoSet @PSBoundParameters
    return $result
}
