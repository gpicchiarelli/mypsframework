# Wrapper generato automaticamente per il comando Copy-NetFirewallRule
...
function Copy-NetFirewallRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Copy-NetFirewallRule
    # Ad esempio:
    $result = &Copy-NetFirewallRule @PSBoundParameters
    return $result
}
