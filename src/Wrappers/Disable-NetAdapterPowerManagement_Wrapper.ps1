# Wrapper generato automaticamente per il comando Disable-NetAdapterPowerManagement
...
function Disable-NetAdapterPowerManagement {
    ...
    # Inserisci qui la logica per utilizzare il comando Disable-NetAdapterPowerManagement
    # Ad esempio:
    $result = &Disable-NetAdapterPowerManagement @PSBoundParameters
    return $result
}
