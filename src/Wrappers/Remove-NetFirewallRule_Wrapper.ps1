# Wrapper generato automaticamente per il comando Remove-NetFirewallRule
...
function Remove-NetFirewallRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Remove-NetFirewallRule
    # Ad esempio:
    $result = &Remove-NetFirewallRule @PSBoundParameters
    return $result
}
