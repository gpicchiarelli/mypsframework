# Wrapper generato automaticamente per il comando Disable-NetFirewallRule
...
function Disable-NetFirewallRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Disable-NetFirewallRule
    # Ad esempio:
    $result = &Disable-NetFirewallRule @PSBoundParameters
    return $result
}
