# Wrapper generato automaticamente per il comando Copy-NetIPsecMainModeRule
...
function Copy-NetIPsecMainModeRule {
    ...
    # Inserisci qui la logica per utilizzare il comando Copy-NetIPsecMainModeRule
    # Ad esempio:
    $result = &Copy-NetIPsecMainModeRule @PSBoundParameters
    return $result
}
